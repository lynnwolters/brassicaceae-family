<script>
    ...
    const svgInnerRadius = svgOuterRadius - 220;
            ...
            <div class="popup-content">
                ...
                <div class="popup-content-main">
                    ...
                    <div class="popup-content-main-info">
                        <h2>{selectPopup.data.speciesName}</h2>
                        <div>
                            <button>
                                iNaturalist
                                <div>
...
<style>
    ...
    .nav-logo > div:nth-of-type(1) div {
        aspect-ratio: 1/1;
        height: 100%;
    ...
    .nav-logo > div:nth-of-type(1) div img {
        width: 50%;
    }
    ...
    .popup-content-main-labels button:hover {
        background-color: var(--color-1);
    }
    ...
    .popup-content-main-info div {
        display: flex;
        flex-wrap: wrap;
    }

    .popup-content-main-info div button {
        width: fit-content;
        height: 2.5em;
    ...
    .popup-content-main-info div button div {
        aspect-ratio: 1/1;
        height: 100%;
    ...
    .popup-content-main-info div button div img {
        width: 50%;
    }

    .popup-content-main-info button:hover {
        background-color: var(--color-1);
    }
